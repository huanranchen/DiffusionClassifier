...
class CIFAR10C(datasets.VisionDataset):
    def __init__(self,
        ...
        self.data = np.concatenate([self.data[0:100], self.data[10000:10100],
                                    self.data[20000:20100], self.data[30000:30100],
                                    self.data[40000:40100]])
        self.targets = np.concatenate([self.targets[0:100], self.targets[10000:10100],
                                       self.targets[20000:20100], self.targets[30000:30100],
                                       self.targets[40000:40100]])
